...
{{< alert type="info" >}}
ただいま、[株式会社トラストバンク](https://www.trustbank.co.jp/) ではメンバーを大募集しています。  
エンジニアやデザイナー、プロジェクトマネージャーやカスタマーサポートなど、幅広い職種をご用意し、みなさまのご応募を心よりお待ちしています。

「ヒト」「モノ」「おカネ」「情報」をはじめとした地域内循環を生み出し、持続可能な地域をつくるための取り組みを一緒に行いませんか？

募集職種は [こちら](https://sg.wantedly.com/companies/trustbank/projects) から
{{</ alert >}}
